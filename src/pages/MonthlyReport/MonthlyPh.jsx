...
const MonthlyPh = () => {
  ...
  const handleFieldKeyDown = (e, index, field) => {
    ...
    // From comment → go to next row's MLSS
    let nextField = field;
    if (field === "comment") {
      nextField = "mlss";
    }

    const nextId = `${nextField}-${nextIndex}`;
                                  ...
                                  >
                                    ...
                                    <td style={{ padding: "8px 10px" }}>
                                      <input
                                        ...
                                        onKeyDown={(e) =>
                                          handleFieldKeyDown(e, index, "mlss")
                                        }
                                        disabled={
                                          (!isOperator && !isAdmin) || loading
                                        }
