...
const MonthlyPh = () => {
  ...
  // MonthlyPh.jsx - REPLACED ENTIRE RETURN BLOCK
  return (
    // Keep this outer Fragment to return multiple children if necessary
    <>
      <div className="row">
        <div className="col-lg-3 d-none d-lg-block">
          {/* <DashboardSam /> // Keeping the original sidebar in the MonthlyPh file, but it will be hidden by the Water.jsx layout. */}
        </div>
            ...
            <div className="col-12">
              ...
              {!targetUser.userName ? (
                ...
                <>
                  ...
                  {/* Now MonthlyPh ends here with InletAndOutlet and Photo section, 
                      which will take the full width of the col-lg-9 from Water.jsx */}
                  <InletAndOutlet />
