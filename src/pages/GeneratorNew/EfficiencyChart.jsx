// components/EfficiencyChart.jsx
...
export default function EfficiencyChart({ data }) {
  return (
    <div className="bg-white rounded-2xl shadow-md p-6 lg:col-span-2">
      <h3 className="text-lg font-semibold text-[#236a80] mb-4 text-center">Hourly Efficiency Trend (kWh/L)</h3>
      <ResponsiveContainer width="100%" height={280}>
        <LineChart data={data}>
          ...
          <Tooltip 
            ...
            cursor={{ fill: "#f0f9ff" }}
            formatter={(value, name) => [value, "Efficiency (kWh/L)"]}
          />
          <Legend />
          <Line
            type="monotone"
